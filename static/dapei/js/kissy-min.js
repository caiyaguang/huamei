    ...
    function j(c, d, h, e, j, i, k) {
        if (e || !(c in d) || i) {
            var s = d[c],
                h = h[c];
            if (s === h) s === b && (d[c] = s);
            else if (i && h && (a.isArray(h) || a.isPlainObject(h))) h[l] ? d[c] = h[l] : (i = s && (a.isArray(s) || a.isPlainObject(s)) ? s : a.isArray(h) ? [] : {}, d[c] = i, g(i, h, e, j, f, k));
    ...
    (function (c, a) {
        ...
        keys: function (a) {
            var d = [],
                b, f;
            for (b in a) d.push(b);
            if (h) for (f = c.length - 1; 0 <= f; f--) b = c[f], a.hasOwnProperty(b) && d.push(b);
            return d
        },
        ...
        augment: function (c, d) {
            ...
            a.isBoolean(j) || (j = b, f++);
            for (; e < f; e++) a.mix(c.prototype, h[e].prototype || h[e], j, g);
            return c
        },
    ...
    a.mix(a, {
        each: function (d, h, c) {
            if (d) {
                ...
                c = c || null;
                if (f) for (f = a.keys(d); e < f.length && !(m = f[e], !1 === h.call(c, d[m], m, d)); e++);
                else for (f = d[0]; e < m && !1 !== h.call(c, f, e, d); f = d[++e]);
            }
            return d
        },
        indexOf: k ?
        function (d, a) {
            ...
            for (var c = 0, b = a.length; c < b; ++c) if (a[c] === d) return c;
            return -1
        },
        lastIndexOf: g ?
        function (d, a) {
        ...
        function (a, b, c) {
            ...
            for (var f = a && a.length || 0, e = 0; e < f; e++) if (e in a && !b.call(c, a[e], e, a)) return !1;
            return !0
        },
        some: e ?
        function (a, b, c) {
            ...
            for (var f = a && a.length || 0, e = 0; e < f; e++) if (e in a && b.call(c, a[e], e, a)) return !0;
            return !1
        },
...
(function (a, b) {
    ...
    a.mix(a, {
        ...
        param: function (c, d, f, e) {
            ...
            for (g in c) if (u = c[g], g = v(g), i(u)) h.push(g), u !== b && h.push(f, v(u + j)), h.push(d);
...
(function (a, b) {
    function i(b, d, e) {
        ...
        if (m) for (b = 0; b < c.length; b++) c[b] = i(c[b], d, e);
        else if (n) for (g in b) if (g !== l && (!d || d.call(b, b[g], g, b) !== j)) c[g] = i(b[g], d, e);
        return c
    }
    function k(f, d, h, c) {
        if (f[e] === d && d[e] === f) return g;
        f[e] = d;
        d[e] = f;
        var m = function (c, a) {
...
(function (a, b) {
    ...
    a.mix(a, {
        ...
        isEmptyObject: function (a) {
            for (var j in a) if (j !== b) return !1;
            return !0
        },
        isPlainObject: function (g) {
            if (!g || "object" !== a.type(g) || g.nodeType || g.window == g) return !1;
            try {
                if (g.constructor && !Object.prototype.hasOwnProperty.call(g, "constructor") && !Object.prototype.hasOwnProperty.call(g.constructor.prototype, "isPrototypeOf")) return !1
            } catch (j) {
                return !1
            }
            for (var i in g);
    ...
    j.prototype = {
        ...
        resolve: function (b) {
            ...
            a.each("scheme,userInfo,hostname,port,path,query,fragment".split(","), function (f) {
                if (f == "path") if (d) h[f] = b[f];
                else {
                    if (f = b.path) {
                        d = 1;
                        if (!a.startsWith(f, "/")) if (h.hostname && !h.path) f = "/" + f;
                        else if (h.path) {
        ...
        toString: function (b) {
            ...
            if (m = this.path) f && !a.startsWith(m, "/") && (m = "/" + m), m = c.normalize(m), h.push(g(m, e));
...
(function (a, b) {
    ...
    if (0 < c.length) {
        ...
        f = d[0];
        for (d = d[1]; f <= d; f++) if (h.innerHTML = "<\!--[if IE {{version}}]><s></s><![endif]--\>".replace("{{version}}", f), 0 < c.length) {
            m[e] = f;
            break
        }
        var p;
        ...
        else if ((f = k.match(/\/([\d.]*) Safari/)) && f[1]) m[e = "safari"] = n(f[1]);
    ...
    k.match(/Presto\/([\d.]*)/)) && f[1]) {
        ...
        m[l = "gecko"] = 0.1;
        if ((f = k.match(/rv:([\d.]*)/)) && f[1]) m[l] = n(f[1]);
...
(function (a) {
    ...
    function k(c, b, d) {
        var c = c.Env.mods,
            e, h, b = a.makeArray(b);
        for (h = 0; h < b.length; h++) if (e = c[b[h]], !e || e.status !== d) return 0;
        return 1
    }
    var g = a.Loader,
        j = a.Path,
    ...
    a.mix(c, {
        ...
        unalias: function (a, c) {
            for (var d = [].concat(c), e, h, f, m = 0, g, j = a.Env.mods; !m;) {
                m = 1;
                for (e = d.length - 1; 0 <= e; e--) if ((h = j[d[e]]) && (f = h.alias)) {
                    m = 0;
        ...
        getMappedPath: function (a, c, b) {
            for (var a = b || a.Config.mappedRules || [], d, b = 0; b < a.length; b++) if (d = a[b], c.match(d[0])) return c.replace(d[0], d[1]);
            return c
        }
    })
})(KISSY);
    ...
    a.augment(k, {
        ...
        getFullPath: function () {
            ...
            if (!this.fullpath) {
                ...
                b = d.getBaseUri();
                c = this.getPath();
                if (d.isIgnorePackageNameInUri() && (h = d.getName())) c = g.relative(h, c);
                b = b.resolve(c);
...
(function (a) {
    ...
    a.augment(b, b.Target, {
        ...
        add: function (b, j, l) {
            ...
            else if (a.isFunction(b)) if (l = j, j = b, i.ie) {
                var b = a.Env.host.document.getElementsByTagName("script"),
                    f, d, h;
                for (d = b.length - 1; 0 <= d; d--) if (h = b[d], "interactive" == h.readyState) {
                    f = h;
                    break
                }
...
(function (a, b) {
    ...
    function g(c, g, j) {
        ...
        a.getScript(v, {
            ...
            success: function () {
                if (g.status == h) if (A) e.registerModule(k, l, a.noop);
    ...
    a.augment(j, {
        use: function (a, b, c) {
            var d, h = new i(function () {
                ...
                a = e.normalizeModNamesWithAlias(f, a);
            d = e.unalias(f, a);
            k(this, d, h);
...
(function (a, b) {
    ...
    function f(d, h) {
        var e, f, m = 0;
        for (e in d) m++;
        if (m) for (e in f = 1, d)(function (e) {
            i(d[e], function () {
    ...
    a.augment(k, {
        ...
        calculate: function (b) {
            var c = {},
                ...
                j = {};
            for (h = 0; h < b.length; h++) e = b[h], m.isAttached(g, e) || (m.isLoaded(g, e) || (c[e] = 1), a.mix(c, d(this, e, j)));
            b = [];
            for (f in c) b.push(f);
            return b
        },
        getComboUrls: function (b) {
            ...
            for (i in f) for (k in f[i]) {
                ...
                for (d = 0; d < B.length; d++) if (F = B[d].getFullPath(), g[k][i].mods.push(B[d]), !D.isCombine() || !a.startsWith(F, J)) g[k][i].push(F);
...
(function (a, b) {
    ...
    if (e && -1 !== (e.search || "").indexOf("ks-debug")) a.Config.debug = !0;
    (function () {
...
(function (a) {
    var b = a.startsWith(location.href, "https") ? "https://s.tbcdn.cn/s/kissy/" : "http://a.tbcdn.cn/s/kissy/";
    a.config({
        packages: {
            gallery: {
                base: b
...
KISSY.add("dom/base/attr", function (a, b, i) {
    ...
    a.mix(b, {
        ...
        prop: function (c, d, h) {
            ...
            d = q[d] || d;
            m = t[d];
            if (h !== i) for (c = e.length - 1; 0 <= c; c--) f = e[c], m && m.set ? m.set(f, h, d) : f[d] = h;
        ...
        hasProp: function (a, c) {
            var d = b.query(a),
                h, e = d.length,
                f;
            for (h = 0; h < e; h++) if (f = d[h], k(f, c) !== i) return !0;
            return !1
        },
        ...
        attr: function (d, h, m, g) {
            ...
            } else for (g = k.length - 1; 0 <= g; g--) if ((l = k[g]) && l.nodeType === j.ELEMENT_NODE)"form" == e(l) && (d = s), d && d.set ? d.set(l, m, h) : l.setAttribute(h, "" + m);
            return i
        },
        removeAttr: function (a, c) {
            var c = c.toLowerCase(),
                ...
                d = b.query(a),
                h, e, m;
            for (m = d.length - 1; 0 <= m; m--) if (e = d[m], e.nodeType == j.ELEMENT_NODE && (e.removeAttribute(c), f.test(c) && (h = q[c] || c) in e)) e[h] = !1
        },
        hasAttr: g && !g.hasAttribute ?
        function (a, c) {
            var c = c.toLowerCase(),
                d = b.query(a),
                h, e;
            for (h = 0; h < d.length; h++) if (e = d[h], (e = e.getAttributeNode(c)) && e.specified) return !0;
            return !1
        } : function (a, c) {
            var d = b.query(a),
                h, e = d.length;
            for (h = 0; h < e; h++) if (d[h].hasAttribute(c)) return !0;
            return !1
        },
        val: function (c, d) {
            var h, f, g, j, k;
        ...
        text: function (a, c) {
            ...
            if (c === i) {
                ...
                h = b.query(a);
                for (e = h.length - 1; 0 <= e; e--) d = h[e], d.nodeType == j.ELEMENT_NODE ? d[l] = c : d.nodeType == j.TEXT_NODE && (d.nodeValue = c)
            }
            return i
        }
    });
...
KISSY.add("dom/base/class", function (a, b, i) {
    function k(e, f, d, h) {
        ...
        for (l = 0; l < c; l++) if (m = e[l], m.nodeType == g.ELEMENT_NODE && (m = d(m, f, f.length), m !== i)) return m;
        return h ? !1 : i
    }
    var g = b.NodeType,
        j = /[\.\s]\s*\.?/,
    ...
    a.mix(b, {
        hasClass: function (a, b) {
            return k(a, b, function (a, b, c) {
                ...
                if (a) {
                    a = (" " + a + " ").replace(l, " ");
                    e = 0;
                    for (f = !0; e < c; e++) if (0 > a.indexOf(" " + b[e] + " ")) {
                        f = !1;
                        break
                    }
                    if (f) return !0
        ...
        removeClass: function (b, f) {
            k(b, f, function (b, h, c) {
                ...
                if (e) if (c) {
                    e = (" " + e + " ").replace(l, " ");
                    for (f = 0; f < c; f++) for (g = " " + h[f] + " "; 0 <= e.indexOf(g);) e = e.replace(g, " ");
                    b.className = a.trim(e)
                } else b.className = ""
            }, i)
        },
    ...
    a.mix(b, {
        create: function (h, m, j, k) {
            ...
            var k = b._creators,
                t, u, j = j || f,
                w, v = c;
            if (r.test(h)) if (w = s.exec(h)) l = j.createElement(w[1]);
            else {
                h = h.replace(n, "<$1></$2>");
        ...
        outerHTML: function (a, h, e) {
            ...
            if (a = g[0]) {
                ...
                h += "";
                if (!h.match(/<(?:script|style|link)/i) && t) for (e = j - 1; 0 <= e; e--) a = g[e], a.nodeType == d.ELEMENT_NODE && (k(a), k(a.getElementsByTagName("*")), a.outerHTML = h);
...
KISSY.add("dom/base/data", function (a, b, i) {
    var k = a.Env.host,
        ...
        h = {
            ...
            removeData: function (b, d) {
                var e = b[g],
                    f;
                if (e) if (f = j[e], d !== i) delete f[d], a.isEmptyObject(f) && h.removeData(b);
                else {
                    delete j[e];
                    try {
                        delete b[g]
    ...
    a.mix(b, {
        ...
        data: function (c, e, f) {
            ...
            } else for (j = c.length - 1; 0 <= j; j--) g = c[j], g.nodeType ? h.data(g, e, f) : d.data(g, e, f);
            return i
        },
...
KISSY.add("dom/base/insertion", function (a, b) {
    function i(a, b) {
        var g = [],
            k, o, q;
        for (k = 0; a[k]; k++) if (o = a[k], q = e(o), o.nodeType == j.DOCUMENT_FRAGMENT_NODE) g.push.apply(g, i(f(o.childNodes), b));
    ...
    a.mix(b, {
        ...
        scrollIntoView: function (h, f, g, j) {
            ...
            if (l = b.get(h)) {
                ...
                if (j) if (o) {
                    if (0 > m || 0 < k)!0 === g ? b.scrollLeft(f, z.left + m) : !1 === g ? b.scrollLeft(f, z.left + k) : 0 > m ? b.scrollLeft(f, z.left + m) : b.scrollLeft(f, z.left + k)
    ...
    a.mix(b, {
        ...
        unique: function () {
            ...
            return function (b) {
                c = d;
                b.sort(a);
                if (c) for (var h = 1, e = b.length; h < e;) b[h] === b[h - 1] ? b.splice(h, 1) : h++;
                return b
            }
        }(),
    ...
    a.mix(b, {
        ...
        style: function (c, d, h) {
            ...
            if (a.isPlainObject(d)) {
                for (e in d) for (f = c.length - 1; 0 <= f; f--) j(c[f], e, d[e]);
                return i
            }
        ...
        css: function (c, d, h) {
            var c = b.query(c),
                ...
                f;
            if (a.isPlainObject(d)) {
                for (f in d) for (e = c.length - 1; 0 <= e; e--) j(c[e], f, d[f]);
                return i
            }
            d = k(d);
            f = A[d];
        ...
        show: function (a) {
            var a = b.query(a),
                d, h, e;
            for (e = a.length - 1; 0 <= e; e--) if (h = a[e], h[m].display = b.data(h, o) || x, "none" === b.css(h, "display")) {
        ...
        unselectable: function (c) {
            var c = b.query(c),
                e, f, g = 0,
                j, i;
            for (f = c.length - 1; 0 <= f; f--) if (e = c[f], d.gecko) e[m].MozUserSelect = "none";
...
KISSY.add("dom/base/traversal", function (a, b, i) {
    function k(e, f, d, h, c, j, k) {
        ...
        for (; e && e != c;) {
            if ((e.nodeType == l.ELEMENT_NODE || e.nodeType == l.TEXT_NODE && k) && g(e, f) && (!h || h(e))) if (j.push(e), !p) break;
            e = e[d]
        }
        return p ? j : j[0] || null
    }
    ...
    a.mix(b, {
        ...
        equals: function (a, f) {
            ...
            for (var d = a.length; 0 <= d; d--) if (a[d] != f[d]) return !1;
            return !0
        }
    });
    return b
...
KISSY.add("dom/ie/create", function (a, b) {
    ...
    b._fixCloneAttributes = function (a, e) {
        ...
        var f = e.nodeName.toLowerCase(),
            d = a.childNodes;
        if ("object" === f && !e.childNodes.length) for (f = 0; f < d.length; f++) e.appendChild(d[f].cloneNode(!0));
        ...
        } else if ("option" === f) e.selected = a.defaultSelected;
...
KISSY.add("dom/ie/insertion", function (a, b) {
    if (8 > (document.documentMode || a.UA.ie)) b._fixInsertionChecked = function k(a) {
        for (var j = 0; j < a.length; j++) {
            ...
            } else if (l.nodeType == b.NodeType.ELEMENT_NODE) for (var l = l.getElementsByTagName("input"), e = 0; e < l.length; e++) k(l[e])
        }
    }
}, {
    requires: ["dom/base"]
    ...
    try {
        null == g.style.opacity && (l.opacity = {
            ...
            set: function (b, d) {
                ...
                h.zoom = 1;
                if ((1 <= d || !g) && !a.trim(j.replace(f, ""))) if (h.removeAttribute("filter"), !g || e && !e.filter) return;
    ...
    b.prototype = {
        ...
        findObserver: function (a) {
            var b = this.observers,
                g;
            for (g = b.length - 1; 0 <= g; --g) if (a.equals(b[g])) return g;
            return -1
        }
    };
    return b
...
KISSY.add("event/base/observer", function (a) {
    ...
    b.prototype = {
        ...
        notify: function (a, b) {
            var g;
            g = a._ks_groups;
            if (!g || this.groups && this.groups.match(g)) return g = this.notifyInternal(a, b), !1 === g && a.halt(), g
        }
    };
    return b
});
        ...
        detach: function (a) {
            ...
            if (g.length) {
                ...
                if (h || b) {
                    c = c || e;
                    j = a = 0;
                    for (i = []; a < t; ++a) if (k = g[a], r = k.context || e, c != r || h && h != k.fn || b && !k.groups.match(b)) i[j++] = k;
                    this.observers = i
                } else this.reset();
                this.checkMemory()
            }
...
KISSY.add("event/dom/base/api", function (a, b, i, k, g, j, l) {
    ...
    function f(b, c, d) {
        ...
        if (!(i = f.handle)) i = f.handle = function (a) {
            var b = a.type,
                c = i.currentTarget;
            if (!(j.triggeredEvent == b || "undefined" == typeof KISSY)) if (b = j.getCustomEvent(c, b)) return a.currentTarget = c, a = new l(a), b.notify(a)
        }, i.currentTarget =
        b;
            ...
            d.batchForType(function (b, c, h, f) {
                ...
                for (f = b.length - 1; 0 <= f; f--) {
                    var g = b[f],
                        ...
                        l = (g || {}).events;
                    if (g && l) if (i)(l = l[i]) && l.detach(k);
                    else for (i in l) l[i].detach(k)
                }
            }, 1, b, c, f, g);
            return b
        },
...
KISSY.add("event/dom/base/object", function (a, b, i) {
    function k(a) {
        ...
        this.isDefaultPrevented = a.defaultPrevented || a.returnValue === f || a.getPreventDefault && a.getPreventDefault() ?
        function () {
            return e
        } : function () {
            return f
    ...
    a.extend(e, l._ObservableEvent, {
        ...
        fire: function (d, h) {
            ...
            if (!h && !d.isDefaultPrevented()) {
                var u;
                try {
                    if (s && f[c] && ("focus" !== c && "blur" !== c || 0 !== f.offsetWidth) && !a.isWindow(f))(u = f[s]) && (f[s] = null), e.triggeredEvent = c, f[c]()
                } catch (v) {}
                u && (f[s] = u);
                e.triggeredEvent = ""
            }
...
KISSY.add("event/dom/ie/change", function (a, b, i) {
    ...
    b._Special.change = {
        setup: function () {
            if (f.test(this.nodeName)) if (k(this)) b.on(this, "propertychange", g), b.on(this, "click", j);
            else return !1;
            else b.on(this, "beforeactivate", l)
        },
        tearDown: function () {
            if (f.test(this.nodeName)) if (k(this)) b.remove(this, "propertychange", g), b.remove(this, "click", j);
            else return !1;
    ...
    j.prototype = {
        ...
        normalize: function (a) {
            ...
            if (!e.isTouchSupported()) {
                if (b.indexOf("mouse") != -1 && a.which != 1) return;
                d = [a];
                b = !b.match(/up$/i);
                a.touches = b ? d : [];
                a.targetTouches = b ? d : [];
        ...
        callEventHandle: function (a, b) {
            ...
            if (b = this.normalize(b)) {
                for (e in d) {
                    ...
                    if (!f.processed) {
                        f.processed = 1;
                        if (f.isActive && f[a](b) === false) f.isActive = 0
                    }
                }
                for (e in d) {
                    f = d[e].handle;
...
KISSY.add("json/json2", function () {
    ...
    function i(a, c) {
        ...
        case "object":
            ...
            } else for (g in t) Object.hasOwnProperty.call(t, g) && (j = i(g, t)) && r.push(b(g) + (l ? ": " : ":") + j);
            j = 0 === r.length ? "{}" : l ? "{\n" + l + r.join(",\n" + l) + "\n" + q + "}" : "{" + r.join(",") + "}";
            l = q;
            return j
        }
    ...
    k.stringify = function (a, b, f) {
        var g;
        e = l = "";
        if (typeof f === "number") for (g = 0; g < f; g = g + 1) e = e + " ";
...
KISSY.add("ajax/iframe-transport", function (a, b, i, k) {
    ...
    function j(f, d, h) {
        ...
        a.each(f, function (f, l) {
            g = a.isArray(f);
            j = a.makeArray(f);
            for (i = 0; i < j.length; i++) k = e.createElement("input"), k.type = "hidden", k.name = l + (g && h ? "[]" : ""), k.value = j[i], b.append(k, d), c.push(k)
        });
        return c
    }
    function l(a) {
    ...
    a.augment(l, {
        ...
        _callback: function (e) {
            var d = this,
                ...
                e = e.type,
                g, j = c.iframe;
            if (j) if ("abort" == e && 6 == a.UA.ie ? setTimeout(function () {
                b.attr(h, d.attrs)
...
KISSY.add("ajax/methods", function (a, b, i) {
    function k(b) {
        ...
        if (g || e) {
            ...
            "*" == p[0];) p.shift();
            if (!p.length) for (c in n) if (n[c].test(f)) {
                p[0] != c && p.unshift(c);
                break
            }
            p[0] = p[0] || "text";
    ...
    a.extend(b, a.Promise, {
        ...
        getResponseHeader: function (a) {
            var b, e;
            if (2 === this.state) {
                if (!(e = this.responseHeaders)) for (e = this.responseHeaders = {}; b = g.exec(this.responseHeadersString);) e[b[1]] = b[2];
                b = e[a]
            }
            return b === i ? null : b
        },
        ...
        _ioReady: function (a, b) {
            if (2 != this.state) {
                ...
                this.readyState = 4;
                var e;
                if (200 <= a && 300 > a || 304 == a) if (304 == a) b = "not modified", e = !0;
                else try {
    ...
    a.augment(g, {
        ...
        _callback: function (a, b) {
            var d = this.script,
                h = this.io,
                c = this.head;
            if (d && (b || !d.readyState || /loaded|complete/.test(d.readyState) || "error" == a)) d.onerror = d.onload = d.onreadystatechange = null, c && d.parentNode && c.removeChild(d), this.head = this.script = k, !b && "error" != a ? h._ioReady(200, "success") : "error" == a && h._ioReady(500, "script error")
        },
        abort: function () {
            this._callback(0, 1)
        }
...
KISSY.add("ajax/xhr-transport-base", function (a, b) {
    ...
    a.mix(l.proto, {
        sendInternal: function () {
            ...
            if (i = c.xhrFields) for (u in i) g[u] = i[u];
            q && g.overrideMimeType && g.overrideMimeType(q);
            r["X-Requested-With"] || (r["X-Requested-With"] = "XMLHttpRequest");
            if ("undefined" !== typeof g.setRequestHeader) for (u in r) g.setRequestHeader(u, r[u]);
        ...
        _callback: function (d, g) {
            ...
            try {
                if (g || 4 == c.readyState) if (j && c instanceof j ? (c.onerror = a.noop, c.onload = a.noop) : c.onreadystatechange = a.noop, g) 4 !== c.readyState && c.abort();
                else {
                    l = k(t);
                    var s = c.status;
...
KISSY.add("base/attribute", function (a, b) {
    ...
    function n(a, c, e, h) {
        ...
        if ((k = g(j(a), c, !0).validator) && (k = i(a, k))) if (a = k.call(a, e, c, h), a !== b && !0 !== a) return a;
        return b
    }
    c.INVALID = {};
    var p = c.INVALID;
...
KISSY.add("base", function (a, b, i) {
    function k(a) {
        ...
        if (a) for (var f in a) this.setInternal(f, a[f])
    }
...
KISSY.add("anim/base", function (a, b, i, k, g, j, l) {
    ...
    function d() {
        ...
        if (!1 === this.fire("beforeStart")) this.stop(0);
            ...
            if (e.nodeType == q.ELEMENT_NODE) for (l in i = "none" === b.css(e, "display"), o) if (f = o[l], "hide" == f && i || "show" == f && !i) {
                this.stop(1);
                return
            }
            if (e.nodeType == q.ELEMENT_NODE && (o.width || o.height)) f = e.style, a.mix(d, {
                overflow: f.overflow,
    ...
    e.prototype = {
        ...
        _frame: function () {
            var a, b = this.config,
                c = 1,
                d, e, f = this._fxs;
            for (a in f) if (!(e = f[a]).finished) b.frame && (d = b.frame(e)), 1 == d || 0 == d ? (e.finished = d, c &= d) : (c &= e.frame()) && b.frame && b.frame(e);
        ...
        stop: function (a) {
            var b = this.config,
                d = b.queue,
                e, f = this._fxs;
            if (!this.isRunning()) return !1 !== d && l.remove(this), this;
            if (a) {
                for (e in f) if (!(a = f[e]).finished) b.frame ? b.frame(a, 1) : a.frame(1);
                this.fire("complete")
            }
            g.stop(this);
            c(this);
...
KISSY.add("node/anim", function (a, b, i, k, g) {
    ...
    a.augment(k, {
        ...
        isRunning: function () {
            for (var a = 0; a < this.length; a++) if (i.isRunning(this[a])) return !0;
            return !1
        },
        isPaused: function () {
            for (var a = 0; a < this.length; a++) if (i.isPaused(this[a])) return 1;
            return 0
        }
    });
    a.each({
