...
var $cateFun = function() {
        var st = $(document).scrollTop(), 
            headh = 190,           
            $nav_classify = $("div.nav-main");
            $jnav_classify = $("div.jiu-nav-main");
			$ynav_classify = $("div.advance-nav");
        if(st > headh){
            $nav_classify.addClass("fixed");
			$jnav_classify.addClass("fixed");
			$ynav_classify.addClass("fixed");
        } else {
            $nav_classify.removeClass("fixed");
			$jnav_classify.removeClass("fixed");
			$ynav_classify.removeClass("fixed");
        }
    };
