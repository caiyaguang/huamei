...
<div class="line-cate-nav-location">
        <div class="line-cate-nav-wrapper">
			...
			<li class="first"><a class="active" href="{:U('jiu/index')}">9.9包邮</a></li>
			<volist name="tag_list" id="bcate">
			<li><a <if condition="$tag eq $bcate['id']">class="active"</if> href="{:U('jiu/index', array('tag'=>$bcate['id']))}">{$bcate.name}</a></li>
			</volist>
