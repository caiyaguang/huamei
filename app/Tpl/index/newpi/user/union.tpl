		...
		<div class="right">
			...
			<div class="invite_way">
				<div class="w1">
					...
					<div class="link">
						<h4>通过QQ、旺旺等邀请好友</h4>
						<p><input type="text" class="ls copy-link1" style="width:335px" value="{$union_url}" readonly /><input class="get" id="copy-btn1" type="button" value="" /></p>
					</div>
				</div>
				<div class="w2">
					<div class="icon"></div>
					<div class="link">
						<h4>在自己常去的论坛上挂签名</h4>
						<p><textarea type="text" class="ls ls2 copy-link2" readonly />[url={$union_url}]{:C('ftx_site_name')}[/url]</textarea><input class="get" id="copy-btn2" type="button" value="" /></p>
					</div>
				</div>
				<div class="w3">
					<div class="icon"></div>
					<div class="link">
						...
						<p><textarea type="text" class="ls ls2 copy-link3" readonly /><a href="{$union_url}" target="_blank">{:C('ftx_site_name')}</a></textarea><input class="get" id="copy-btn3" type="button" value="" /></p>
					</div>
				</div>
				<div class="w5">
					<div class="icon"></div>
					<div class="link">
						...
						<p><textarea type="text" class="ls ls2" style="width:400px;height:80px;" readonly/>您可以在自己的QQ空间、人人网、豆瓣网或其它你常去的网站发表博文，以自己的口吻告诉你的朋友，推荐您的朋友加入{:C('ftx_site_name')}，一起分享购物返现！</textarea></p>
					</div>
				</div>
			</div>
