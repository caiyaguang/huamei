...
<html>
    ...
    <div class="login-content">
        <div class="title">
            ...
            <p class="other">还没有账号，<a target="_blank" href="{:U('user/register')}">立即去注册</a></p></div>
        <div class="login-center">
                    ...
                    <ul>
                        <li>
						   <div class="user">
                            ...
                            <input type="text" class="normal-input" placeholder="用户名/邮箱" name="username">							
						   </div>
                        ...
                        <li>
						   <div class="user">
                            ...
                            <input type="password" class="normal-input"  placeholder="请输入密码" name="password" autocomplete="off">
							</div>
                        ...
                        <li class="chex-d">
                            ...
                            <div class="chex">
                                <span><label><input type="checkbox" class="ck" name="remember" checked="checked" value="1">两周内免登录</label></span>
                                <a class="forget " href="{:U('forget/index')}">忘记密码？</a></div>
                        </li>
                        <li>
                            <label class="normal"></label>
                            <div class="btn">
                                ...
                                <input type="submit" name="sub" class="sub smt-o" value="登录" autocomplete="off">
                                </div>
                        </li>
                        <li class="third-login">
                            <label class="normal"></label>
                            <div class="union-login">
                                <p class="union-title"><span>合作网站账号登陆</span><em class="line"></em></p>
                                <div class="third-box">
           ...
           {:R('advert/index', array(4), 'Widget')}
            ...
            <p class="foot-tips">{:C('ftx_site_name')} <a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ftx_site_icp')}</a>   Copyright © 2010 - 2014 {:C('ftx_site_url')} All Rights Reserved</p>
        </div>
    </div>
