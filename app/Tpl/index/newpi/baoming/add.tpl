...
<div class="main {:C('ftx_site_width')} mb20">
	<div class="main-newgood -2" style="text-align:left">
		...
		<form action="{:U('baoming/add',array('do'=>'submit'))}" method="post" name="form" id="form" onsubmit="return check_zhe();" enctype="multipart/form-data">
			<div class="bm-form">
			...
			<div class="bm-form" style="border:0">
				<table>
					...
					<tr>
						<th>推荐理由：</th>
						<td><textarea id="intro" name="intro" class="form-textarea" cols="10" rows="80">请务必以客观的角度评价您的商品，否则会影响到您商品的审核。</textarea></td>
					</tr>
...
function getTaoItem(url){
	...
	$.getJSON(FTXIAER.root + '{:U("baoming/ajaxGetItem")}', {url:url}, function(result){
