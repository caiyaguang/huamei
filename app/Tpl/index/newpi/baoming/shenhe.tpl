...
<div class="main {:C('ftx_site_width')} mb20 clear">
	<div class="main-newgood" style="text-align:left">
		<div class="textcls">
			<h2>审核说明</h2>
			<div class="line"></div>
			<div class="content">
...
<p style="border-bottom:0px;border-left:0px;padding-bottom:10px;line-height:24px;margin-top:0px;padding-left:20px;padding-right:20px;white-space:normal;margin-bottom:0px;color:#666666;font-size:14px;border-top:0px;border-right:0px;padding-top:10px;">
	1、9.9包邮秒杀报名要求。<a href="{:U('bao/yaoqiu')}" target="_blank">查看详细&gt;&gt;</a><br />
2、20元封顶报名要求。<a href="{:U('bao/yaoqiu')}" target="_blank">查看详细&gt;&gt;</a><br />
3、独家折扣报名要求。<a href="{:U('bao/yaoqiu')}" target="_blank">查看详细&gt;&gt;</a> 
</p>
<p style="padding-bottom:10px;line-height:24px;padding-left:0px;padding-right:0px;display:block;white-space:normal;color:#ff6600;font-size:16px;padding-top:10px;">
	五、商家报名规则
</p>
...
<div class="area" id="contentD">
  <span>
    报名咨询：    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin={:C('ftx_qq')}&site={:C('ftx_site_name')}&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:{:C('ftx_qq')}:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>

     <a target=blank href="http://amos.im.alisoft.com/msg.aw?v=2&uid={:C('ftx_kefu_html')}&site=cntaobao&s=1&charset=utf-8"><img border="0" SRC="http://amos.im.alisoft.com/online.aw?v=2&uid={:C('ftx_kefu_html')}&site=cntaobao&s=1&charset=utf-8" alt="点击这里给我发消息"></a>
