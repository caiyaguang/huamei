	...
	<div class="shang_mr" style="border:1px solid #DCDCDC;background:#FFF">
		...
		<div class="shang_621_top" style="height:90px;border-bottom:1px solid #dcdcdc;padding-top:22px;padding-left:63px">
			<div class="shang_621_top1 tupian6">
				<h1 style="font-size:16px;color:#999;padding:5px 0;">我的余额提现</h1>
				<font style="color:#999">请认真填写您的优惠社的密码，建议六个字母以上！</font>
			</div>
		</div>
	  
		<div style="margin:64px 10px 85px 61px ;">
		
		   <div style="padding:0px 15px 13px 29px;">用&nbsp;&nbsp;户&nbsp;&nbsp;名&nbsp;:<span style="color:#fb7804;padding:0 15px;">ikillcash</span>
		   </div>
		   
			<form action="" method="post">
			
				<div class="mi_d">原始密码：
					<input class="mimain" name="ypwd" type="password"> 
					<img src="__STATIC__/tupian/mimadian.png" align="absmiddle">
				</div>
				
				<div class="mi_ds">填写原始密码进行核对！</div>
				
				<div class="mi_d">新改密码：
					<input class="mimain" name="password" type="password"> 
					<img src="__STATIC__/tupian/mimadian.png" align="absmiddle">
				</div>
			
				<div class="mi_ds">填写新修改密码，并牢牢记住哦，当忘记密码时可以找回密码！</div>
				
				<div class="mi_d">确认密码：
					<input class="mimain" name="pwd" type="password">
					<img src="__STATIC__/tupian/mimadian.png" align="absmiddle">
				</div>
				
				<div class="mi_ds">重新输入新修改密码，以确保您已经记下修改的密码</div>
				
				<div class="mi_ds">
					<input class="mimasu tupian13" value="提交" type="submit">
				</div>
