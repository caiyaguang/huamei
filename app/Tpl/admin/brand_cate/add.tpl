...
<div class="dialog_content">
	<form id="info_form" action="{:u('brand_cate/add')}" method="post">
	<table width="100%" class="table_form">
		<tr> 
			<th width="120">{:L('brand_cate_parent')} :</th>
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="{:U('brand_cate/ajax_getchilds')}" data-selected="{$spid}"></select>
...
$(function(){
	...
	$("#name").formValidator({onshow:lang.please_input+lang.brand_cate_name,onfocus:lang.please_input+lang.brand_cate_name}).inputValidator({min:1,onerror:lang.please_input+lang.brand_cate_name});
