...
<form id="info_form" action="{:U('payzhe/editSubmitPay')}" method="post">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<th>收款帐号 :</th>
			<td>
				<input type="text" name="alipay" id="alipay" value="{$info.alipay}" class="input-text" size="30">
			</td>
		</tr>
		<tr>
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		<tr>
			<th>活动价格:</th>
			<td>
			   <input type="text" name="price" id="price" value="{$info.price}"  class="input-text" size="25"> 
			</td>
		</tr>
		<tr>
			<th>活动周期 :</th>
			<td>
				 <input type="text" name="days"  id="days" value="{$info.days}" class="input-text" size="10">&nbsp;&nbsp;天
			</td>
		</tr>
		<tr>
			<th>展示地址 :</th>
			<td>
				 <input type="text" name="booth"  value="{$info.booth}" class="input-text" size="60">
			</td>
		</tr>
		<tr>
            <th>要求 :</th>
            <td><textarea name="requirement" id="requirement" cols="50" rows="4">{$info.requirement}</textarea></td>
        </tr>
	</table>
	</div>
	<div class="content_list pad_10 hidden">
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		<tr>
			<th>二维码:</th>
			<td>
			<input type="text" name="pic_url" id="J_cate_img" class="input-text fl mr10" style="width:250px" value="{$info.pic_url}">
