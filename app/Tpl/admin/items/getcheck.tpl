	...
	<table width="100%" cellpadding="3" cellspacing="1" class="table_form">
		...
		<tr>
			...
			<td>
					...
					<input type="radio" value="2" name="pass" class="radio" id="fpass">
                    <label for="fpass" class="radio_lalel">初审通过</label>&nbsp;&nbsp;&nbsp;
		...
		<tr class="fpassd">
			<th width="80">初审通知 :</th>
			<td>
			<textarea name="fpass_reason" cols="48" rows="5">{$item.fail_reason}</textarea>
			</td>
		</tr>
