        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
                    ...
                    <input type="hidden" name="a" value="fcheck" />
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="center"><img data-tdtype="toggle" data-id="{$val.id}" data-field="pass" data-value="{$val.pass}" src="__STATIC__/images/admin/toggle_<if condition="$val.pass eq 2">disabled<else/>enabled</if>.gif" /></td>
