...
<div class="dialog_content">
	<form id="info_form" action="{:u('tehui_cate/edit')}" method="post">
	<table width="100%" class="table_form">
		<tr>
			<th width="120">{:L('tehui_cate_parent')} :</th>
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="{:U('tehui_cate/ajax_getchilds')}" data-selected="{$info.spid}"></select>
				<input type="hidden" name="pid" id="J_cate_id" />
			</td>
		</tr>
		<tr>
			<th>{:L('tehui_cate_name')} :</th>
...
$(function(){
	...
	$("#name").formValidator({onshow:lang.please_input+lang.tehui_cate_name,onfocus:lang.please_input+lang.tehui_cate_name}).inputValidator({min:1,onerror:lang.please_input+lang.tehui_cate_name}).defaultPassed();
    ...
    var uploader = new qq.FileUploaderBasic({
        ...
        multiple: false,
        action: "{:U('tehui_cate/ajax_upload_img')}",
        inputName: 'img',
