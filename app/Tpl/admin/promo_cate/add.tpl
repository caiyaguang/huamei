...
<div class="dialog_content">
	<form id="info_form" action="{:u('promo_cate/add')}" method="post">
	<table width="100%" class="table_form">
		<tr> 
			<th width="120">{:L('promo_cate_parent')} :</th>
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="{:U('promo_cate/ajax_getchilds')}" data-selected="{$spid}"></select>
...
$(function(){
	...
	$("#name").formValidator({onshow:lang.please_input+lang.promo_cate_name,onfocus:lang.please_input+lang.promo_cate_name}).inputValidator({min:1,onerror:lang.please_input+lang.promo_cate_name});
