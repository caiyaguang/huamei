...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0" class="search_form">
        ...
        <tr>
            ...
            <div class="explain_col">
                ...
                &nbsp;&nbsp;{:L('article_cateid')}：
                <select class="J_cate_select mr10" data-pid="0" data-uri="{:U('dapei_cate/ajax_getchilds')}" data-selected="{$search.selected_ids}"></select>
    ...
    <div class="J_tablelist table_list" data-acturi="{:U('dapei/ajax_edit')}">
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width=150><span data-tdtype="order_by" data-field="cate_id">{:L('article_cateid')}</span></th>
        ...
        <tbody>
            ...
            <tr>
				...
				<td align="center">{$val.styleid}</td>
                <td align="center"><span data-tdtype="edit" data-field="title" data-id="{$val.id}" class="tdedit" style="color:{$val.colors};">{$val.title}</span><notempty name="val['pic_url']"><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="{$img_dir}{$val.pic_url}"><img src="__STATIC__/images/filetype/image_s.gif" /></span></notempty></td>
				<td align="center">{$val.itemnum}</td>
                ...
                <td align="center"><a href="{:u('dapei/edit', array('id'=>$val['id'], 'menuid'=>$menuid))}">{:L('edit')}</a> | <a href="javascript:void(0);" class="J_confirmurl" data-acttype="ajax" data-uri="{:u('dapei/delete', array('id'=>$val['id']))}" data-msg="{:sprintf(L('confirm_delete_one'),$val['title'])}">{:L('delete')}</a></td>
            </tr>
            </volist>
        </tbody>
    </table>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="{:U('dapei/delete')}" data-name="id" data-msg="{:L('confirm_delete')}" value="{:L('delete')}" />
