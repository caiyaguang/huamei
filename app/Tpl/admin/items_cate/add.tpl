...
<form id="info_form" action="{:U('items_cate/add')}" method="post">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<th>优惠券 :</th>
			<td>
				<label><input type="radio" name="quan" value="0" > 显示</label>&nbsp;&nbsp;
				<label><input type="radio" name="quan" value="1" checked> 不显示</label>
			</td>
		</tr>
		 ...
		 <tr>
			...
			<td>
				<select name="sort" class="J_tbcats mr10">
				    <option value="rand()*100"  >随机排序</option>
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		<tr>
			<th>图标:</th>
			<td><input type="text" name="cateimg" id="J_cate_img" class="input-text fl mr10" style="width:250px" value=""></td>
...
$(function(){
    var upload = new qq.FileUploaderBasic({
        ...
        multiple: false,
        action: "{:U('items_cate/ajax_upload')}",
        inputName: 'img',
