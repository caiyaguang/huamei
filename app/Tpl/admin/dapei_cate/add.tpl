...
<div class="dialog_content">
	<form id="info_form" action="{:u('dapei_cate/add')}" method="post">
	<table width="100%" class="table_form">
		<tr> 
			<th width="120">{:L('article_cate_parent')} :</th>
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="{:U('dapei_cate/ajax_getchilds')}" data-selected="{$spid}"></select>
