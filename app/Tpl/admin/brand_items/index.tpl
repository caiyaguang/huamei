...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0" class="search_form">
        ...
        <tr>
            ...
            <div class="explain_col">
                ...
                <input type="hidden" name="m" value="brand_items" />
                ...
                &nbsp;&nbsp;{:L('tehui_cateid')}：
                <select class="J_cate_select mr10" data-pid="0" data-uri="{:U('brand_cate/ajax_getchilds')}" data-selected="{$search.selected_ids}"></select>
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
				...
				<th width=50><span data-tdtype="order_by" data-field="num_iid">商品ID</span></th>
				...
				<th width=100><span data-tdtype="order_by" data-field="activityId">所属活动</span></th>				
				<th width="350">推荐语</th>
				<th width="40"><span data-tdtype="order_by" data-field="price">原价</span></th>
                <th width="40"><span data-tdtype="order_by" data-field="coupon_price">折扣价</span></th>
				<th width="40"><span data-tdtype="order_by" data-field="coupon_rate">折扣</span></th>
        ...
        <tbody>
            ...
            <tr>
				...
				<td align="center"><b>{$bcate_list[$val['activityId']]}</b></td>
				...
				<td align="center"><b>{$val['coupon_price']}</b></td>
				<td align="center"><b>{$val['coupon_rate']}</b></td>
                ...
                <td align="center"><a href="{:u('brand_items/edit', array('id'=>$val['id'], 'menuid'=>$menuid))}">{:L('edit')}</a> | <a href="javascript:void(0);" class="J_confirmurl" data-acttype="ajax" data-uri="{:u('brand_items/delete', array('id'=>$val['id']))}" data-msg="{:sprintf(L('confirm_delete_one'),$val['title'])}">{:L('delete')}</a></td>
            </tr>
            </volist>
        </tbody>
    </table>
    ...
    <div class="btn_wrap_fixed">
		...
		<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="pass" data-uri="{:U('brand_items/pass')}" data-name="id" data-title="批量设置状态" value="状态" />
		<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="{:U('brand_items/move')}" data-name="id" data-title="{:L('item_cate_move')}" value="{:L('move')}" />
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="{:U('brand_items/delete')}" data-name="id" data-msg="{:L('confirm_delete')}" value="{:L('delete')}" />
