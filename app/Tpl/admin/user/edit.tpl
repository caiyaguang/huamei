...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
        ...
        <tr>
			<th>账户余额 :</th>
			<td><input type="text" name="money" class="input-text" value="{$info.money}" size="30"></td>
		</tr>
        <tr>
			<th>积分 :</th>
		...
		<tr>
        	<th>用户类型 :</th>
            <td>
            	<label><input type="radio" name="login_type" value="1" <if condition="$info.login_type eq 1">checked</if>> 普通用户</label>&nbsp;&nbsp;
