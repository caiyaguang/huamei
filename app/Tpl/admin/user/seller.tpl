    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="120"><span data-tdtype="order_by" data-field="money">账户余额</span></th>
                ...
                <th width="170">{:L('operations_manage')}</th>
            </tr>
        </thead>
    	<tbody>
            ...
            <tr>
                ...
                <td align="center">
                <a href="javascript:;" class="J_showdialog" data-uri="{:u('user/add_money', array('id'=>$val['id'], 'menuid'=>$menuid))}" data-title="充值 - {$val.username}" data-id="add_score" data-width="400" data-height="170">充值</a> |
