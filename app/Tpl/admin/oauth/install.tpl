...
<div class="dialog_content" style="padding:0 20px;">
	<form id="info_form" action="{:U('oauth/install')}" method="post">
...
$(function(){
	...
	$("#J_name").formValidator({ onshow:lang.please_input+lang.oauth_name, onfocus:lang.please_input+lang.oauth_name, oncorrect:lang.input_right}).inputValidator({ min:1, onerror:lang.please_input+lang.oauth_name});
