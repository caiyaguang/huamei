...
<title>正在跳转到爱淘宝...</title>
<script src="__STATIC__/js/jquery/jquery.js" type="text/javascript"></script>
</head>
<body>
<if condition="$item.click_url eq ''">
<div style="visibility:hidden;" >
 <a data-type="0" biz-itemid="{$item.num_iid}" data-style="2"  data-tmpl="230x312" style="visibility:hidden;"></a>
</div>
...
<else />
<script language="javascript">var iurl="{$item.click_url}";document.write("<meta http-equiv=\"refresh\" content=\"0;url="+iurl+"\" />");</script>
</if>
</body>
</html>