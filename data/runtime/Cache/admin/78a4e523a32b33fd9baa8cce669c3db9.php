<?php if (!defined('THINK_PATH')) exit();?><!--菜单添加--><div class="dialog_content"><form id="info_form" name="info_form" action="<?php echo u('menu/add');?>" method="post"><table width="100%" class="table_form"><tr><th width="100"><?php echo L('menu_parentid');?> :</th><td><select name="pid"><option value="0"><?php echo L('no_parent_menu');?></option><?php echo ($select_menus); ?></select></td></tr><tr><th><?php echo L('menu_name');?> :</th><td><input type="text" name="name" id="name" class="input-text"></td></tr><tr><th><?php echo L('module_name');?> :</th><td><input type="text" name="module_name" id="module_name" class="input-text"></td></tr><tr><th><?php echo L('action_name');?> :</th><td><input type="text" name="action_name" id="action_name" class="input-text"></td></tr><tr><th><?php echo L('att_data');?> :</th><td><input type="text" name="data" id="data" class="input-text"></td></tr><tr><th><?php echo L('remark');?> :</th><td><textarea name="remark" id="remark" cols="40" rows="3"></textarea></td></tr><tr><th><?php echo L('menu_display');?> :</th><td><label><input type="radio" name="display" class="radio_style" value="1" checked="checked"><?php echo L('yes');?>&nbsp;&nbsp;</label><label><input type="radio" name="display" class="radio_style" value="0"><?php echo L('no');?></label></td></tr></table></form></div><script>$(function(){
