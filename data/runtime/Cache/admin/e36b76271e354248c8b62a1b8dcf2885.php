...
<div class="showMsg" style="text-align:center">
    ...
    <div class="bottom">
    <?php if(isset($jumpUrl)): echo L('sys_will');?><span style="color:green;font-weight:bold"><?php echo ($waitSecond); ?></span><?php echo L('page_jump_tip');?><a href="<?php echo ($jumpUrl); ?>"><?php echo L('here');?></a>
