...
a:link,a:visited{text-decoration:none;color:#289121}
...
--></style><title><?php echo L('page_msg');?></title></head><body><div class="showMsg" style="text-align:center"><h5><?php echo ($msgTitle); ?></h5><?php if(isset($message)): ?><div class="content ok" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;"><?php echo ($message); ?></div><?php endif; ?><div class="bottom"><?php if(isset($jumpUrl)): echo L('sys_will');?><span style="color:green;font-weight:bold"><?php echo ($waitSecond); ?></span><?php echo L('page_jump_tip');?><a href="<?php echo ($jumpUrl); ?>"><?php echo L('here');?></a><script language="javascript">		setTimeout("location.href='<?php echo ($jumpUrl); ?>';",<?php echo ($waitSecond); ?>*1000);
